...
namespace TfvcMigrator.Operations
{
    ...
    {
        public MergeOperation(BranchIdentity sourceBranch, string sourceBranchPath, BranchIdentity targetBranch, string targetBranchPath)
        {
        ...
        public override string ToString() => $"{SourceBranchPath} ↣ {TargetBranchPath}";
